...
This builds the jar with Maven and starts the server on port `27171`.
...
Health check: `GET http://localhost:27171/actuator/health`

Swagger UI: `http://localhost:27171/docs`
OpenAPI JSON: `http://localhost:27171/api-docs`
